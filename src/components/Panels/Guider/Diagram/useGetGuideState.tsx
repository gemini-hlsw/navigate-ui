...
export function useGetGuideState() {
  ...
  return {
    ...
    m2FocusEnable: false,
    m2FocusSource: "OIWFS",
    m2TipTiltEnable: Boolean(data.guideState.m2Inputs)
      ? Boolean(data.guideState.m2Inputs.length > 0)
      : false,
    m2TipTiltFocusLink: true,
    m2TipTiltSource: Boolean(data.guideState.m2Inputs)
      ? data.guideState.m2Inputs.join(",")
      : "NONE",
    probeTracking: "OI➡OI",
  }
}
