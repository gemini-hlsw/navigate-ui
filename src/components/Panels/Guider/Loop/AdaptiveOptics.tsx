...
import {
  useGetAltairGuideLoop,
  useUpdateAltairGuideLoop,
} from "@gql/configs/AltairGuideLoop"
import { AltairGuideLoopType, GemsGuideLoopType } from "@/types"
import {
  useGetGemsGuideLoop,
  useUpdateGemsGuideLoop,
} from "@gql/configs/GemsGuideLoop"

export function Altair() {
  const { canEdit } = useContext(AuthContext)
  const [state, setState] = useState<AltairGuideLoopType>(
    {} as AltairGuideLoopType
  )
