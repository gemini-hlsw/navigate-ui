  ...
  return (
    <Title title="Telescope Setup" prevPanel={prevPanel} nextPanel={nextPanel}>
      <TitleDropdown icon='list'>
        <Button disabled={!canEdit} className="p-button-text" label="Import from ODB" onClick={() => setOdbVisible(true)} />
        <Button disabled={!canEdit} className="p-button-text" label="Import from Fixed Targets" onClick={() => setTargetVisible(true)} />
